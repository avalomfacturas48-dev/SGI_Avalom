        ...
        <AccordionItem value="contable" className="border rounded-lg shadow-sm bg-card">
          <AccordionTrigger className="px-3 py-3 sm:px-6 sm:py-4 hover:no-underline">
            <div className="flex items-center gap-3 w-full">
              <div className="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-lg bg-gradient-to-br from-primary/20 to-primary/10">
                <TrendingUp className="h-5 w-5 text-primary" />
              </div>
              <div className="flex-1 text-left">
                <h3 className="text-base font-bold sm:text-lg">Reporte Contable</h3>
          ...
          <AccordionContent className="px-3 pb-3 sm:px-6 sm:pb-6">
        ...
        <AccordionItem value="ejecutivos" className="border rounded-lg shadow-sm bg-card">
          <AccordionTrigger className="px-3 py-3 sm:px-6 sm:py-4 hover:no-underline">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex-1 text-left">
                <h3 className="text-base font-bold sm:text-lg">Reportes Ejecutivos</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
        ...
        <AccordionItem value="gastos" className="border rounded-lg shadow-sm bg-card">
          <AccordionTrigger className="px-3 py-3 sm:px-6 sm:py-4 hover:no-underline">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex-1 text-left">
                <h3 className="text-base font-bold sm:text-lg">Reportes de Gastos</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
        ...
        <AccordionItem value="administrativos" className="border rounded-lg shadow-sm bg-card">
          <AccordionTrigger className="px-3 py-3 sm:px-6 sm:py-4 hover:no-underline">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex-1 text-left">
                <h3 className="text-base font-bold sm:text-lg">Reportes Administrativos</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
